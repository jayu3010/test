...
import { Button, Checkbox, Flex, Form, Table, Tabs, Upload } from 'antd';
...
const FuturePlanningWithOutData = () => {
  ...
  return (
    <Flex>
      ...
      <div className="w-full ml-5 overflow-auto resulted-data-table">
        ...
        <Button className="btn-main text-white mt-4">Simulate</Button>
...
export default FuturePlanningWithOutData;
